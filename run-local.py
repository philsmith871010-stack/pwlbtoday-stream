...
"""run-local.py — the client front end on your Mac, with live reload.
    ...
    python3 run-local.py            open the site at http://localhost:8030
    python3 run-local.py --build    rebuild the council files first, then open
...
def main():
    ...
    print(f"  open      {url}\n")
    print("  Edit index.html and the page reloads itself, back on the tab and")
    print("  the scroll position you were on. Ctrl-C to stop.\n")
